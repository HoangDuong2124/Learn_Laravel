    ...
    <ul class="nav top-menu">
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="dashboard/img/3.png"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="dashboard/img/1.png"></span>
                                <span class="subject">
                                <span class="from">John Doe
								</span>
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="dashboard/img/2.png"></span>
                                <span class="subject">
